...
## Installation
```
go get github.com/yourname/logmiddleware
```
...
```golang
func main() {
    logDB, logErr := logmiddleware.model.InitLogDB()
	if logErr != nil {
    ...
    if logErr == nil {
		...
		go logmiddleware.logger.StartLogWriter(logDB)
		// use logger middleware
		r.Use(logmiddleware.logger.RequestLogMiddleware())
	}
